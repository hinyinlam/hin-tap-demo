...
```json
{
  "apiDescription" : "This is a restful API demo",
  "apiOwner" : "Hin Lam",
  "apiSystem" : "VMware Demo",
  "artifactId" : "hin-artifact",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=hinyinlam&repo=hin-tap-demo",
  "buildTool" : "maven",
  ...
  "packageName" : "com.vmware.hin",
  "projectName" : "hin-rest-service",
  "sourceRepositoryPrefix" : "github.com/hinyinlam"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol packageDirectory with value 'com/vmware/hin'
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'hin-artifact'
┃ ┃ ┃ Debug Adding symbol databaseResourceName with value 'hin-db'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [<groupId>com.vmware.tap.accelerators</groupId>-><groupId>com.vmware<...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->This is a restful AP...(truncated), OWNER_VAL->Hin Lam, SYSTEM_VAL->VMware Demo]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [rest-service-db->hin-artifact]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [customer-profile-database->hin-db]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [customerprofiledatabase->hin-db]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->hin-artifact]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->github.com/hinyinlam]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=hinyinlam&repo=hin-tap-demo'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [com.vmware.tap.accelerators.restservicedb->com.vmware.hin]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileRepository.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgres.yaml didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug pom.xml didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileService.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/Application.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileEntity.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/api/CustomerProfileController.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/ApplicationTests.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileRepository.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgres.yaml didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug pom.xml didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileService.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/Application.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileEntity.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/api/CustomerProfileController.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/ApplicationTests.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/api/CustomerProfileControllerTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileResponse.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileCreateRequest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileRepository.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug config/postgres.yaml didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug pom.xml didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/domain/CustomerProfileService.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/Application.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/data/CustomerProfileEntity.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug Tiltfile didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/hin/api/CustomerProfileController.java didn't match [manifest.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/data/CustomerProfileRepositoryTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/domain/CustomerProfileServiceTest.java didn't match [manifest.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/hin/ApplicationTests.java didn't match [manifest.yaml] -> included
