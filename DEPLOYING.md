...
```
tanzu apps workload create hin-artifact -f config/workload.yaml \
  --local-path . \
  --source-image github.com/hinyinlam/hin-artifact-source \
  --type web
```
...
```
tanzu apps workload get hin-artifact
```
